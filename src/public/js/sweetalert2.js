		...
		_(o, e, 'header'),
			...
			t && o.icon === t.icon
				...
				? o.icon && -1 === Object.keys(X).indexOf(o.icon)
					? (K('Unknown icon! Expected "success", "error", "warning", "info" or "question", got "'.concat(o.icon, '"')),
					  at(n))
					...
					var n,
						...
						e =
							...
							function () {
								...
								return p(
									this,
									o ? ((t = c(this).constructor), Reflect.construct(e, arguments, t)) : e.apply(this, arguments)
								);
							});
					function i() {
	...
	var Ve = ['swal-title', 'swal-html', 'swal-footer'],
		...
		We = function (e) {
			...
			g(e.querySelectorAll('*')).forEach(function (t) {
				t.parentNode === e &&
					((t = t.tagName.toLowerCase()), -1 === n.indexOf(t) && W('Unrecognized element <'.concat(t, '>')));
			});
		},
		Ke = function (e, n) {
